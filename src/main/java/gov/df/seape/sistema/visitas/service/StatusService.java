...
public interface StatusService {
     ...
     */
    PageResponseDTO<StatusResponseDTO> listarStatusPaginado(Pageable pageable);
    ...
    /**
     * Busca um status pela descrição exata.
     * 
     * @param descricao Descrição exata do status
     * @return Status encontrado, se existir
     */
    Optional<StatusResponseDTO> buscarPorDescricaoExata(String descricao);
}
