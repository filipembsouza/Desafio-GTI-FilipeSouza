...
import lombok.extern.slf4j.Slf4j; // Adicione essa importação para usar log
...
public class DataInitializer {
    ...
    public CommandLineRunner initData() {
        return args -> {
            ...
            List<Perfil> perfis = Arrays.asList(
                // Exemplo: "ADMIN (Administrador do Sistema)"
            ...
            // Substituímos System.out.println por log.info
    ...
    // Ajustamos o método para usar ambos os parâmetros, evitando o warning de "unused parameter".
    private Perfil createPerfil(String descricao, String nome) {
        Perfil perfil = new Perfil();
        // Se sua entidade Perfil só tem "descricao", você pode concatenar ambos:
